...
public class APIService {
	//一键注册
	  ...
	  public static final String COURSE_INFO="http://123.57.210.52/api/v1/courses/show?";
	  ...
	  //按省份划分的球场列表
	  public static final String SEARCH_COURSE="http://123.57.210.52/api/v1/courses/sectionalized_by_province?";
