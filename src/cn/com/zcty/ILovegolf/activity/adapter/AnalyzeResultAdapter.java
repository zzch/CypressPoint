...
public class AnalyzeResultAdapter extends BaseAdapter {
	
	private ArrayList<String> scoresArrayList;
	private ArrayList<String> scoregrid;
	private LayoutInflater inflater;
	private Context context;
	public AnalyzeResultAdapter(Context context,ArrayList<String> scoresArrayList,ArrayList<String> scoregrid) {
