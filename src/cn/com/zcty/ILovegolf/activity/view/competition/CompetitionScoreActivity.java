...
import cn.com.zcty.ILovegolf.activity.adapter.CompetitionScoreAdapter;
...
import cn.com.zcty.ILovegolf.activity.view.ScoreCardActivity;
...
public class CompetitionScoreActivity extends Activity implements IXListViewListener ,RemoveListener,OnItemClickListener{
	private XListView mListView;
	private ImageView image_tishi;
	private CompetitionScoreAdapter slideAdapter;
	...
	Handler handler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			...
			if(msg.what==2){
				...
				Toast.makeText(CompetitionScoreActivity.this, "删除成功", Toast.LENGTH_LONG).show();
				slideAdapter.notifyDataSetChanged();
			}else{
				Toast.makeText(CompetitionScoreActivity.this, "删除失败,当前网络不稳定", Toast.LENGTH_LONG).show();
				image_tishi.setVisibility(View.INVISIBLE);
				mListView.setVisibility(View.VISIBLE);
			}
			}
	...
	private void getData() {
		slideAdapter = new CompetitionScoreAdapter(this, quickArrayList,nameArrayList);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
		...
		editor.commit();
		intent =new Intent(CompetitionScoreActivity.this,ScoreCardActivity.class);
		//intent传值
