...
public class QuickScoreActivity extends Activity implements IXListViewListener {
    ...
    private  XListView mListView; //listView 控件
    private  Intent intent;
   // private QuickScoreAdapter quickScoreAdapter;    //适配器
    private List<QuickContent> quickContent=new ArrayList<QuickContent>();           //历史赛事的信息集合
