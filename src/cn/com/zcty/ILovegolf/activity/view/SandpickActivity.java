...
public class SandpickActivity extends Activity {
	...
	/*
	 * private TextView cishuTextView4; private TextView ganshuTextView4;
		...
		public void handleMessage(Message msg) {
			if (msg.what == 1) {
				...
				if (arrayDistances.get(0).getShots_to_hole().equals("null")) {
					...
					ganshuTextView.setText(arrayDistances.get(0)
							.getShots_to_hole());
				}
				...
				if (arrayDistances.get(1).getShots_to_hole().equals("null")) {
					...
					ganshuTextView2.setText(arrayDistances.get(1)
							.getShots_to_hole());
				}
				...
				if (arrayDistances.get(2).getShots_to_hole().equals("null")) {
					...
					ganshuTextView3.setText(arrayDistances.get(2)
							.getShots_to_hole());
				}
	...
	private void initView() {
		 ...
		 * ganshuTextView4 = (TextView)
		 * findViewById(R.id.putts_average_gancount_4); tuijinTextView4 =
		 * (TextView) findViewById(R.id.putts_average_fist_4); fisTextView4 =
		 * (TextView) findViewById(R.id.putts_average_shengyu_4);
		 */
	...
	public void onClick(View v) {
		Intent intent;
		switch (v.getId()) {
		case R.id.help_shakeng_1:
			intent = new Intent(SandpickActivity.this,
					HelpAverageActivity.class);
			intent.putExtra("shakeng1", "shakeng1");
			startActivity(intent);
			break;

		case R.id.help_shakeng_2:
			intent = new Intent(SandpickActivity.this,
					HelpAverageActivity.class);
			intent.putExtra("shakeng2", "shakeng2");
			startActivity(intent);
			break;

		case R.id.help_shakeng_3:
			intent = new Intent(SandpickActivity.this,
					HelpAverageActivity.class);
			intent.putExtra("shakeng3", "shakeng3");
			startActivity(intent);
			break;

		case R.id.help_shakeng_4:
			intent = new Intent(SandpickActivity.this,
					HelpAverageActivity.class);
			intent.putExtra("shakeng4", "shakeng4");
			startActivity(intent);
			break;
		}
	}
	...
	class SandPitTask extends Thread {
		...
		public void getData() {
			...
			try {
				...
				JSONObject js04 = new JSONObject(
						jsonObject.getString("item_04"));
				...
				JSONObject js1 = new JSONObject(
						js04.getString("distance_0_10_from_hole_in_bunker"));
				...
				JSONObject js2 = new JSONObject(
						js04.getString("distance_10_20_from_hole_in_bunker"));
				...
				JSONObject js3 = new JSONObject(
						js04.getString("distance_20_50_from_hole_in_bunker"));
				...
				JSONObject js4 = new JSONObject(
						js04.getString("distance_50_100_from_hole_in_bunker"));
