 ...
 */
    ...
    public class MajorListChoosePitchActivity extends Activity {
	...
	Handler handler = new Handler(){
		public void handleMessage(Message msg) {
			if(msg.arg1==1){
				 adapter = new SortAdapter(MajorListChoosePitchActivity.this, citys, child);
				...
				sortListView.setOnChildClickListener(new OnChildClickListener() {
					...
					public boolean onChildClick(ExpandableListView parent, View v,
						...
						editor.commit();
						Intent intent = new Intent(MajorListChoosePitchActivity.this,PlaySetActivity.class);
	...
	private void setListeners() {
		...
		search_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				//Intent intent=new Intent(MajorListChoosePitchActivity.this,MajorChoosePitchActivity.class );
				//startActivity(intent);
				finish();
			}
		});	
			...
			public void afterTextChanged(Editable s) {
				if(s.length()!=0){
					...
					for(int i=0;i<adapter.getGroupCount();i++){
					   ...
					   SearchCityAdapter adapters = new SearchCityAdapter(citys_name,citys_address,MajorListChoosePitchActivity.this);
